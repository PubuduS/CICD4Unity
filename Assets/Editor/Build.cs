...
public class Build
{
    ...
    {//c:\workspace\DLR-Demo\UWP\output\UWP => c:\workspace\DLR-Demo\UWP\output\UWP\ProjectName\ProjectName.vcxproj
        ...
        content = content.Replace("<AppxBundle>Auto</AppxBundle>",
            ...
            "    <AppInstallerUri>https://built-artifacts.s3.us-east-2.amazonaws.com/_MRTK_GUI.appinstaller" + "</AppInstallerUri>"); //HTTP-File Server (just mirroring the Network Drive)
